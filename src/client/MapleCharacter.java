...
public class MapleCharacter extends AnimatedMapleMapObject implements Serializable, MapleCharacterLook {
    ...
    public int blackslot, bloodslot, accountid, id, hair, face, secondHair, secondFace, faceMarking, ears, tail, elf, mapid, fame, pvpExp, pvpPoints, totalWins, totalLosses,
            ...
            remainingAp, honourExp, honorLevel, runningLight, runningLightSlot, runningDark, runningDarkSlot, luminousState, starterquest, starterquestid, evoentry, rbpoints;
    private Point old;
    ...
    private boolean invincible, canTalk, clone, followinitiator, followon, smega, hasSummon, getpetvac, upgrade=false;
...
//            client.getSession().write(InventoryPacket.updateSpecialItemUse(item, type == MapleInventoryType.EQUIPPED ? (byte) 1 : type.getType(), this));
   ...
   //     client.getSession().write(CField.getAndroidTalkStyle(2008, "Yay", 2));
    ...
    public int getblackslot(){
        return blackslot;
    }
    public void setblackslot(int b){
        this.blackslot = b;
    }
    
    public int getbloodslot(){
    return bloodslot;
    }
    public void setbloodslot(int i) {
        this.bloodslot = i;
    }
    ...
    public void turnpetvac(){
        getpetvac = getpetvac ? false : true;
        stats.recalcLocalStats(this);
    }
...
//        client.getSession().write(EffectPacket.updateDeathCount(deathCount));
    ...
    */
    ...
    public void doReborn() {
     ...
     ++rbpoints;
        this.level = 10;
        this.updateSingleStat(MapleStat.LEVEL, 10);
        this.resetStats(4, 4, 4, 4);
            this.setRemainingAp((short)this.getRemainingAp() - 1200);
            this.setRemainingAp((short)this.getRemainingAp() + 50);
            this.updateSingleStat(MapleStat.AVAILABLEAP, this.getRemainingAp());
        resetSkills();
        changeJob(GameConstants.getBeginnerJob(job));
