...
//        System.out.println(getSkillBook(skillid / 10000));
    ...
    public static boolean isPickupRestricted(int itemId) {
        return itemId == 5155000 || itemId == 4030004;
    }
    ...
    private static final int[][] WheelRewardWhite = new int[][]{{2003566, 5062001, 2004149, 2004159, 2012000, 2022090, 2040776}, 
        {2003570, 4031879, 4033570, 1152089, 1122252}, 
        {1012376, 1022212, 1132243, 1112794, 1032168, 1032220, 5750000, 1702433, 1702442, 1702419, 1702423, 1202072}, 
        {5063100}, 
        {5062002, 4035000, 1113063, 3010681, 3010680, 3010679, 1132211, 1132244, 1152120, 1122256, 1122265}, 
        {4035001, 1002140, 1012439, 1152156, 1032223, 3010662, 3010652, 3010522}, 
        {1113070, 1132247}};
    private static final int[][] WheelRewardRed = new int[][]{{2022121, 2022965, 2004193, 2049159, 2210069, 2210078, 2210122, 2003570}, 
        {1012071, 4033570, 1132161, 1132164, 1132165, 1132166, 1132167, 1132168}, 
        {3010653, 3010654, 3010655, 3010656, 3010521, 3010608, 1012070, 1132211, 1202071, 1152120, 1152124, 1112586, 2049160, 1122264, 1190300, 4035001}, 
        {1032191, 1113064, 1113065, 3010724, 1082149, 1032221, 1113070, 1132245, 1132248, 1112439, 1182019, 1132212, 1152121}, 
        {1114000, 1152121, 1032216, 1132215, 1162018, 1152160, 1132230, 1132169, 1132170, 1132171, 1132172, 1132173, 1032224, 1122267, 1202091, 1122269, 1202090, 1202089, 1132213, 1152122, 4035002}};
    private static final int[][] WheelRewardGold = new int[][]{{2003570, 1122220, 2003568, 5062002, 5060004, 5062090, 4031879}, 
        {5063100, 5200000, 5200001, 4035005, 1132228, 4035000, 1152099, 1113066}, 
        {3010651, 3010670, 3010676, 3010519, 3010520, 1113038, 1113057, 1032225, 1132214, 1152123, 1132008, 4031878, 1202075, 1152161, 1112663, 1112929, 1190302, 1202067, 5200002, 4035001}, 
        {1132174, 1132175, 1132176, 1132177, 1132178, 1022211, 1032217, 1012438, 1152155, 3010725, 1122266, 1032222, 1182067, 1082148, 1202089, 1202090, 1202091, 3063300, 3063350, 2930000}, 
        {1113078, 1132215, 1082149, 3064311, 3064431, 1132246, 1002140, 1113070, 4035002, 4035003}};
    private static final int[] Percents = new int[]{40000, 30000, 15000, 10000, 4500, 500, 10};
    private static final int[] Percents2 = new int[]{500, 300, 150, 45, 5};
    

    public static void loadWheelRewards(LinkedList<Integer> items, LinkedList<Integer> percents, int token) {
    
        int rank = token % 10;
        int[][] rewards = rank == 2 ? WheelRewardGold : (rank == 1 ? WheelRewardWhite : WheelRewardRed);
        switch (rank) {
            case 1: {
                for (int i = 0; i < 7; ++i) {
                    items.add(rewards[i][Randomizer.nextInt(rewards[i].length)]);
                    percents.add(Percents[i]);
                }
                for (int j = 0; j < 2; ++j) {
                    int a = Randomizer.nextInt(rewards[j].length);
                    while (items.contains(rewards[j][a])) {
                        a = Randomizer.nextInt(rewards[j].length);
                    }
                    items.add(rewards[j][a]);
                    percents.add(Percents[j]);
                }
                items.add(4035003);
                percents.add(0);
                break;
