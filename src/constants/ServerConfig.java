...
public class ServerConfig {
    ...
    public static final int EXP = 11; //exp rate (only works when fixedRates = true)
    public static final int MESO = 1; //meso rate (only works when fixedRates = true)
