...
public class MapleItemInformationProvider {
    ...
    public void runEtc() {
        ...
        for (MapleData dat : potsData) {
            ...
            for (MapleData potLevel : dat.getChildByPath("level")) {
                ...
                item.name = MapleDataTool.getString("info/string", dat, "");
                ...
                for (final String i : StructItemOption.types) {
                    ...
                    item.name = item.name.replaceAll("#".concat(i), String.valueOf(MapleDataTool.getIntConvert(i, potLevel, 0)));
                }
                switch (item.opID) {
                    case 31001: // Haste
    ...
    public final Item scrollEquipWithId(final Item equip, final Item scrollId, final boolean ws, final MapleCharacter chr, final int vegas) {
        if (equip.getType() == 1) { // See Item.java
            ...
            final int recover = (GameConstants.isCleanSlate(scrollId.getItemId()) && stats.containsKey("recover")) ? stats.get("recover") : 1; 
            final int added = (ItemFlag.LUCKY_DAY.check(equip.getFlag()) ? 10 : 0) + (chr.getTrait(MapleTraitType.craft).getLevel() / 10);
            int success = chr.getupgrade()? 100 : (succ + (vegas == 5610000 && succ == 10 ? 20 : (vegas == 5610001 && succ == 60 ? 30 : 0)) + added);
            ...
            if (GameConstants.isPotentialScroll(scrollId.getItemId()) || GameConstants.isEquipScroll(scrollId.getItemId()) || GameConstants.isSpecialScroll(scrollId.getItemId()) || Randomizer.nextInt(100) <= success) {
                switch (scrollId.getItemId()) {
                    ...
                    default: {
                        if (GameConstants.isInno(scrollId.getItemId())) {
                            Equip ret = (Equip) getEquipById(nEquip.getItemId());
                            ret.setPotential1(nEquip.getPotential1());
                            ret.setPotential2(nEquip.getPotential2());
                            ret.setPotential3(nEquip.getPotential3());
                            ret.setBonusPotential1(nEquip.getBonusPotential1());
                            ret.setBonusPotential2(nEquip.getBonusPotential2());
                            ret.setBonusPotential3(nEquip.getBonusPotential3());
                            nEquip.resetStat(ret);
                        } else if (GameConstants.isChaosScroll(scrollId.getItemId())) {
                            final int z = (GameConstants.isicog(scrollId.getItemId()) || GameConstants.isMchaos(scrollId.getItemId()))? 10:5;
                            final boolean w = (GameConstants.isicog(scrollId.getItemId()) || GameConstants.iscog(scrollId.getItemId())) ? true : false;
                            
                            if (nEquip.getStr() > 0) {
                                nEquip.setStr((short) (nEquip.getStr() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getDex() > 0) {
                                nEquip.setDex((short) (nEquip.getDex() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getInt() > 0) {
                                nEquip.setInt((short) (nEquip.getInt() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getLuk() > 0) {
                                nEquip.setLuk((short) (nEquip.getLuk() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getWatk() > 0) {
                                nEquip.setWatk((short) (nEquip.getWatk() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getWdef() > 0) {
                                nEquip.setWdef((short) (nEquip.getWdef() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getMatk() > 0) {
                                nEquip.setMatk((short) (nEquip.getMatk() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getMdef() > 0) {
                                nEquip.setMdef((short) (nEquip.getMdef() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getAcc() > 0) {
                                nEquip.setAcc((short) (nEquip.getAcc() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getAvoid() > 0) {
                                nEquip.setAvoid((short) (nEquip.getAvoid() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getSpeed() > 0) {
                                nEquip.setSpeed((short) (nEquip.getSpeed() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getJump() > 0) {
                                nEquip.setJump((short) (nEquip.getJump() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getHp() > 0) {
                                nEquip.setHp((short) (nEquip.getHp() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            if (nEquip.getMp() > 0) {
                                nEquip.setMp((short) (nEquip.getMp() + Randomizer.nextInt(z) * (w ? 1:(Randomizer.nextBoolean() ? 1 : -1))+1));
                            }
                            break;
                        } else if (GameConstants.isEquipScroll(scrollId.getItemId())) {
                            final int[] rate = new int[]{95,90,85,80,75,70,65,60,55,45,35,25,20,10,5};
                            final int enh = nEquip.getEnhance();
                            final int id = scrollId.getItemId();
                            final int chanc = (chr.getupgrade() || (id >= 2049334 && id <= 2049342))? 100 : (id > 2049330 && id <= 2049333) ? 10 : (rate[enh] + added);
                            int loop = (id == 2049331 || id == 2049334) ? 5 : (id == 2049332 || id == 2049337) ? 10 : (id == 2049333 || id == 2049342) ? 15 : 1;
                            if (Randomizer.nextInt(100) > chanc) {
                                return null; //destroyed, nib
                            }
                            
                            for (int i = 0; i < loop; i++){
                                int enh2 = nEquip.getEnhance();
                                int bonus = (enh2 >= 0 && enh2 < 5 ) ? 0 : (enh2 >= 5 && enh2 < 10) ? 5 : 10;
                                int a = 1 + bonus;
                                boolean att = Randomizer.nextBoolean();
                                if (att) {
                                    if (nEquip.getMatk() > 0)
                                       nEquip.setMatk((short) (nEquip.getMatk() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getWatk() > 0)
                                   nEquip.setWatk((short) (nEquip.getWatk() + a + Randomizer.nextInt(5)));
                                } else {
                                   if (nEquip.getStr() > 0)
                                       nEquip.setStr((short) (nEquip.getStr() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getDex() > 0)
                                       nEquip.setDex((short) (nEquip.getDex() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getInt() > 0)
                                       nEquip.setInt((short) (nEquip.getInt() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getLuk() > 0)
                                       nEquip.setLuk((short) (nEquip.getLuk() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getWdef() > 0)
                                       nEquip.setWdef((short) (nEquip.getWdef() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getMdef() > 0)
                                       nEquip.setMdef((short) (nEquip.getMdef() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getAcc() > 0)
                                       nEquip.setAcc((short) (nEquip.getAcc() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getAvoid() > 0)
                                       nEquip.setAvoid((short) (nEquip.getAvoid() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getSpeed() > 0)
                                       nEquip.setSpeed((short) (nEquip.getSpeed() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getJump() > 0)
                                       nEquip.setJump((short) (nEquip.getJump() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getHp() > 0)
                                       nEquip.setHp((short) (nEquip.getHp() + Randomizer.nextInt(5) + a));
                                   if (nEquip.getMp() > 0)
                                       nEquip.setMp((short) (nEquip.getMp() + Randomizer.nextInt(5) + a));
                                   
                                }
                                nEquip.setEnhance((byte) (nEquip.getEnhance() + 1));
                            }
                            /*final int chanc = chr.getupgrade() ? 100 : (Math.max(((scrollId.getItemId() >= 2049334 && scrollId.getItemId() <= 2049342) ||scrollId.getItemId() == 2049300 || scrollId.getItemId() == 2049303 || scrollId.getItemId() == 2049306 ? 100 : (scrollId.getItemId() >= 2049331 && scrollId.getItemId() <= 2049333) ? 10 : (scrollId.getItemId() == 2049308 ? 50 : scrollId.getItemId() == 2049305 ? 60 : 80)) - (nEquip.getEnhance() * 10), 10) + added);
                            if (Randomizer.nextInt(100) > chanc) {
                                return null; //destroyed, nib
                            }
                            for (int i = 0; i < (scrollId.getItemId() == 2049337 ? 10 : scrollId.getItemId() == 2049338 ? 11 : scrollId.getItemId() == 2049339 ? 12 : scrollId.getItemId() == 2049340 ? 13 : scrollId.getItemId() == 2049341 ? 14 : scrollId.getItemId() == 2049342 ? 15 : scrollId.getItemId() == 2049331 || scrollId.getItemId() == 2049334 ? 7 : scrollId.getItemId() == 2049332 || scrollId.getItemId() == 2049335 ? 8 : scrollId.getItemId() == 2049333 || scrollId.getItemId() == 2049336 ? 9 : scrollId.getItemId() == 2049308 ? 5 : (scrollId.getItemId() == 2049305 ? 4 : (scrollId.getItemId() == 2049304 ? 3 : scrollId.getItemId() == 2049309 ? 2 : 1))); i++) {
                            ...
                            break;
                        } else if (GameConstants.isCleanSlate(scrollId.getItemId())) {
                            
                            final int chanc = (chr.getupgrade()) ? 100 : succ + added;
                            if (Randomizer.nextInt(100) > chanc) {
                            ...
                            if (nEquip.getState() <= 17 && scrollId.getItemId() / 100 == 20497 && scrollId.getItemId() >= 2049700 && scrollId.getItemId() < 2049750) {
                                final int chanc = (scrollId.getItemId() == 2049701 ? 80 : 100) + added; // 2049701
                                if (Randomizer.nextInt(100) > chanc) {
                                    return null; //destroyed, nib
                                }
                                nEquip.renewRed(true, 18);
                            } else if (nEquip.getState() <= 18 && scrollId.getItemId() / 100 == 20497 && scrollId.getItemId() >= 2049750 && scrollId.getItemId() < 2049770){
                            int chanc = (scrollId.getItemId() == 2049750 || scrollId.getItemId() == 2049753 ? 80 : (scrollId.getItemId() == 2049751 || scrollId.getItemId() == 2049754 ? 60 : (scrollId.getItemId() == 2049755 || scrollId.getItemId() == 2049757 ? 50 : 30))) + added;
                                if (Randomizer.nextInt(100) > chanc) {
                                        return null;
                                    }
                                nEquip.renewRed(true, 19);
                                    break;
                            } else if (nEquip.getState() <= 19 && scrollId.getItemId() / 100 == 20497 && scrollId.getItemId() >= 2049770) {
                              int chanc = (scrollId.getItemId() == 2049770 ? 100 : 50) + added;
                                    if (Randomizer.nextInt(100) > chanc) {
                                        return null;
                                    }
                                    nEquip.renewRed(true, 20);
                                    break;  
                ...
                if (!GameConstants.isInno(scrollId.getItemId()) && !GameConstants.isCleanSlate(scrollId.getItemId()) && !GameConstants.isSpecialScroll(scrollId.getItemId()) && !GameConstants.isEquipScroll(scrollId.getItemId()) && !GameConstants.isPotentialScroll(scrollId.getItemId())) {
