...
public class AdminCommand {
    ...
    public static class Mem extends CommandExecute {
...
public static class chopoint extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (chrs == null) {
                ...
                c.getPlayer().dropMessage(6, splitted[1] + " has " + chrs.getDPoints() + " points, after giving " + splitted[2] + ".");
            }
            return 1;
        }
    }
    ...
    public static class autoscroll extends CommandExecute {
        public int execute(MapleClient c, String[] s) {
            c.getPlayer().turnupgrade();
            c.getPlayer().dropMessage(5, "Auto scroll mode: "+(c.getPlayer().getupgrade()?"ON":"OFF"));
            return 1;
        }
    }
    ...
    extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] s) {
            ...
            if (!ii.itemExists(itemId)) {
                ...
                short flag = 0;
                if (s[2].equalsIgnoreCase("UNTRADABLE")) {
                    flag = (short)ItemFlag.UNTRADABLE.getValue();
                } else if (s[2].equalsIgnoreCase("lock")) {
                    flag = (short)ItemFlag.LOCK.getValue();
                } else if (s[2].equalsIgnoreCase("spikes")) {
                    flag = (short)ItemFlag.SPIKES.getValue();
                } else if (s[2].equalsIgnoreCase("cold")) {
                    flag = (short)ItemFlag.COLD.getValue();
                } else if (s[2].equalsIgnoreCase("karmaeq")) {
                    flag = (short)ItemFlag.KARMA_EQ.getValue();
                } else if (s[2].equalsIgnoreCase("karmause")) {
                    flag = (short)ItemFlag.KARMA_USE.getValue();
                } else if (s[2].equalsIgnoreCase("charm")) {
                    flag = (short)ItemFlag.CHARM_EQUIPPED.getValue();
                } else if (s[2].equalsIgnoreCase("android")) {
                    flag = (short)ItemFlag.ANDROID_ACTIVATED.getValue();
                } else if (s[2].equalsIgnoreCase("craft")) {
                    flag = (short)ItemFlag.CRAFTED.getValue();
                } else if (s[2].equalsIgnoreCase("craftuse")) {
                    flag = (short)ItemFlag.CRAFTED_USE.getValue();
                } else if (s[2].equalsIgnoreCase("shield")) {
                    flag = (short)ItemFlag.SHIELD_WARD.getValue();
                } else if (s[2].equalsIgnoreCase("lucky")) {
                    flag = (short)ItemFlag.LUCKY_DAY.getValue();
                } else if (s[2].equalsIgnoreCase("slot")) {
                    flag = (short)ItemFlag.SLOTS_PROTECT.getValue();
                } else if (s[2].equalsIgnoreCase("scroll")) {
                    flag = (short)ItemFlag.SCROLL_PROTECT.getValue();
                } else {
                    c.getPlayer().dropMessage(5, "Wrong");
                    return 0;
                }
                Item item = GameConstants.getInventoryType(itemId) == MapleInventoryType.EQUIP ? ii.getEquipById(itemId) : new Item(itemId,(byte) 0,(byte) 1,(byte) 0);
                item.setFlag(flag);
                MapleInventoryManipulator.addbyItem(c, item);
            }
            return 1;
    ...
    public static class showPacket extends CommandExecute {
        public int execute (MapleClient c, String[] s) {
            c.getPlayer().dropMessage(5,String.valueOf(SendPacketOpcode.valueOf(s[1])));
            return 1;
        }
    }
